...
bool CRenderSystemGLES::BeginOffscreenRoundedGroup(const CRect& rectScreenTL, const std::array<float, 4>& radiiPx)
{
  GLint vp[4] = {0, 0, 0, 0};
...
void CRenderSystemGLES::EndOffscreenRoundedGroup()
{
  ...
  glViewport(state.prevViewport[0], state.prevViewport[1],
             state.prevViewport[2], state.prevViewport[3]);
